<template>
    <div class="bg-white shadow-md rounded-lg p-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <button @click="uploadFile" :disabled="!selectedFile" class="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed">
          Upload
        </button>
      </div>
    </div>
